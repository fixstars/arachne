...
def compile_for_pytorch(
    ...
    with tempfile.TemporaryDirectory() as tmp_dir:
        ...
        return compile_by_tvm(
            pt_script_path, "pytorch", input_shape_dict, None, target_device, output_path
        )


def compile_for_keras(model, target_device: str, pipeline: str, output_path: str):  # tf.keras.Model
    # TODO: support more compile pipelines
    assert pipeline == "tvm"
    ...
    with tempfile.TemporaryDirectory() as tmp_dir:
        ...
        return compile_by_tvm(
            h5_path, model_format, input_shape_dict, None, target_device, output_path
        )


def compile_for_tf_concrete_function(
    concrete_func, target_device: str, pipeline: str, output_path: str
):
    ...
    with tempfile.TemporaryDirectory() as tmp_dir:
        ...
        return compile_by_tvm(
            frozen_pb_file, "pb", input_shape_dict, output_tensors, target_device, output_path
        )
